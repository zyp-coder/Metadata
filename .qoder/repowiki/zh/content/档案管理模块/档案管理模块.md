...
### API 数据同步：定时任务与手动触发
- 手动触发：
  - refresh-preview：只读预检，比较 schema 变化与数据变化样本，不写库。
...
- [backend/apps/archive/serializers.py:456-527](file://backend/apps/archive/serializers.py#L456-L527)
